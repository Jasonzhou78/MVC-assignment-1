...
1225 Run the app, the new app display its webpage on localhost result is consistent with tutorial
...
23:00
--again, the problem arose after I tried to publish it on Azure, the program does not work.
Somehow some new files autogenerated by MsBuilder, such as MvcMovie.AssemblyInfo.cs
...
--So, the app failed to publish on Azure and even worse, after tried to publish on Azure, the app can not be successfully built anymore. 
